...
<!--canvas-->
    ...
    <div id="canvas1">
        <div class="canvas1-text">
                <p>DROP, SCALE,<br>MATCH &  CREATE</p></a>
                </div>

            <canvas class="canvas1-box" width="430" height="600"></canvas>
          </div>
        </div>
    ...
    <div class="canvas2-box">
      ...
      <a href="tops.php">
       <img class="icon-top" src="img/icon-top.png" style="width:80px;height:102px;">
    </a><div class="icont-top-text">
    <p>Top</p>
    </div>

    <a href="wardrobe.php">
       <img class="icon-outwear" src="img/icon-hanger.png" style="width:80px;height:71px;">
    </a><div class="icont-outwear-text">
    <p>Wardrobe</p>
    </div>

    <a href="dresses.php">
       <img class="icon-dresses" src="img/icon-dress.png" style="width:80px;height:102px;">
    </a><div class="icont-dresses-text">
    <p>Dresses</p>
    </div>

    <a href="outwear.php">
       <img class="icon-shoes" src="img/icon-outwearr.png" style="width:80px;height:102px;">
    </a><div class="icont-shoes-text">
    <p>Outwear</p>
    </div>


  <a href="http://www.w3schools.com/html/html_images.asp">
       <img class="icon-hat" src="img/icon-hat.jpg" style="width:80px;height:91px;">
    </a><div class="icont-hat-text">
    <p>Hat</p>
    </div>

    <a href="wardrobe.php">
       <img class="icon-hanger" src="img/icon-shoes.png" style="width:80px;height:81px;">
    </a><div class="icont-hanger-text">
    <p>Shoes</p>
    </div>
...
<!--buttons canvas -->
                <button class="button-new" type="submit" ><a href="home2.php">New</a></button>
               <button class="button-save" type="submit" ><a href="outfit.php">Save</a></button>
