...
<head>
  ...
  <link rel='stylesheet prefetch' href='http://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.1.0/css/bootstrap.min.css'>
   ...
   <link rel="stylesheet" href="css/style-blog-page3.css">
...
<div class="boxed">
<p>How-To : Photograph Long Sleeves</p>
...
<div class="boxed-2">
<p>Photoshoot of the week : Street Styles</p>
  <div class="post-2-img">
  </div>
    <div class="post-2-img-2">
  </div>
    <div class="post-2-img-3">
  </div>
  ...
  <div id="heart-boxed2">
      <i></i>
      <div class="text-like-boxed2">
            <span>L I K E D !</span>
      </div>
  </div>

    <div id="bt-facebook-boxed2">
<div class="share-block">
            <a href="javascript:void(0);" onclick="window.open ('http://www.facebook.com/sharer.php?u=index.php/&amp;t=The title goes here','tdFBShare','status=0,resizable=1,height=400,width=600');"><img src="bt-facebook.png"></a>
      </div>
      </div>
...
<div class="boxed-3">
<p>Trend Alert : Everyday Graphics Tees </p>
...
<ul class="nav-paginacao">
    ...
    <li class="is-active"><a href="blog-page3.php">3</a></li>
    <li><a href="#">&gt;</a></li>
</ul>
