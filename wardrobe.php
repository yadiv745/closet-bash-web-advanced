...
<head>
  ...
  <link rel='stylesheet prefetch' href='http://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.1.0/css/bootstrap.min.css'>
   ...
   <link rel="stylesheet" href="css/style-wardrobe.css">
...
<!--canvas-->
    ...
    <div id="canvas1">
            <div class="canvas1-text">
                <p>DROP, SCALE,<br>MATCH &  CREATE</p>
            </div>
...
<script src='https://dl.dropboxusercontent.com/u/2241077/imageupload.js'></script>
    ...
    <script src="js/index-upload-wardrobe.js"></script>
